...
var dbPath = ((_b = process.env.E2E_DB_PATH) === null || _b === void 0 ? void 0 : _b.trim()) || path.join(dbDir, "code-clash-e2e-".concat(Date.now(), "-").concat(process.pid, ".sqlite3"));
var uvCacheDir = path.join(os.tmpdir(), "code-clash-uv-cache");
