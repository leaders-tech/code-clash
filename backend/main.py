...
from backend.runner import DockerBotRunner, ServiceBotRunner, ScriptedBotRunner
...
async def on_startup(app: web.Application) -> None:
    ...
    if "bot_runner" not in app:
        if settings.bot_runner_mode == "service":
            app["bot_runner"] = ServiceBotRunner(settings)
        else:
